...
public class HomeModel {
    ...
    public void getListData(BaseHttpEntity<ResponseBody> entity, Map<String, String> map) {
        service.getHomeDatas(map)
    ...
    public void getBannerData(BaseHttpEntity<ResponseBody> entity) {
