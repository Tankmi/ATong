...
public abstract class BaseFragmentActivity extends FragmentActivity {
    ...
    /********************* 头部分控件 *************************/
    @BindView(R.id.iv_title_status_bar_fill)
    public ImageView iv_title_status_bar_fill;
    @BindView(R.id.title)
    public RelativeLayout mTitleView;
    @BindView(R.id.rel_title_view_main)
    public RelativeLayout rel_title_view_main;
    @BindView(R.id.btn_title_view_left)
    public Button mBtnLeft; // 标题左边按钮
    @BindView(R.id.tv_title_view_title)
    public TextView mTvTitle; // 标题
    @BindView(R.id.btn_title_view_right)
