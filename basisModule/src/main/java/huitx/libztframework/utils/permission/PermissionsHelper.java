package huitx.libztframework.utils.permission;
...
public class PermissionsHelper {
    ...
    public void requestEachPermissions(String[] permissions,
                                       IPermissionListenerWrap.IEachPermissionListener eachPermissionListener) {
        getEachPermissionFragment(mActivity).requestEachPermissions(permissions, eachPermissionListener);
    }

    public void requestPermissions(String[] permissions,
                                   IPermissionListenerWrap.IPermissionListener requestpermissionlistener) {
    ...
    private EachPermissionFragment getEachPermissionFragment(FragmentActivity activity) {
        EachPermissionFragment fragment =
                (EachPermissionFragment) mActivity.getSupportFragmentManager().findFragmentByTag(TAG_EACH_PERMISSION);
        if (fragment == null) {
