...
package huitx.libztframework.view.wheel;
...
import huitx.libztframework.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0x99ffffff, 0x00ffffff };
	...
	public void setCenterDrawable(int drawable) {
		centerDrawableId = drawable;
	}
	
	public void closeDrawShadow() {
		drawshadow = false;
	}
	...
	/**
	 * Sets view adapter. Usually net adapters contain different views, so it
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			if(centerDrawableId != 0){
				centerDrawable = getContext().getResources().getDrawable(centerDrawableId);
			}else{
				centerDrawable = getContext().getResources().getDrawable(R.mipmap.wheel_item);
			}
		}
...
//		setBackgroundResource(R.mipmap.wheel_bgs);
	}
