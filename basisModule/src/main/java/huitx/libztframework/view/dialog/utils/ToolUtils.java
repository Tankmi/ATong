package huitx.libztframework.view.dialog.utils;
...
public class ToolUtils {
    ...
    public static void setDialogStyle(BuildBean bean) {
        if (bean.alertDialog != null) {
            Log.i("spoort_list","bean.alertDialog != nullbean.alertDialog != null   222222222222");
            setMdBtnStytle(bean);
        } else {
    ...
    public static void setMdBtnStytle(BuildBean bean) {
        Button btnPositive = bean.alertDialog.getButton(AlertDialog.BUTTON_POSITIVE);
        Button btnNegative =  bean.alertDialog.getButton(AlertDialog.BUTTON_NEGATIVE);
        Button btnNatural = bean.alertDialog.getButton(AlertDialog.BUTTON_NEUTRAL);
    ...
    public static void setDialogStyle(Context context, Dialog dialog, int measuredHeight, BuildBean bean) {
        Log.i("spoort_list"," setDialogStyle");
        if (dialog == null) {
            return;
        }
